...
public class Parameter_scan{
	public static void main(String[] args) {
		...
		for(int sm_box=5;sm_box<25;sm_box+=3)
			for(int bg_box=sm_box+5;bg_box<45;bg_box+=4)
				for(double lambda = 0.7;lambda<3.5;lambda+=0.15)
					for(double realscale=1.0;realscale<3.0;realscale+=.4)
				{
					...
					System.out.print(sm_box+" "+bg_box+" "+_1dp.format(lambda)+" "+_1dp.format(realscale)+"  ");
